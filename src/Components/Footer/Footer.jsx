...
function Footer() {
  ...
  return (
    <div className="bg-gray-900 md:flex md:justify-center md:items-center flex-col text-white w-full py-0 pb-11">
    ...
    <div className="md:flex justify-between items-center flex-col-reverse p-5 gap-2 w-full md:px-36 ">
    <div className='flex gap-6 py-1'>
       <h1 className='uppercase cursor-pointer'>Techtitans</h1>
       <p className=' lowercase cursor-pointer'>PRIVACY POLICY</p>
       <p className=' lowercase cursor-pointer'>YOUR PRIVACY CHOICES</p>
       <p className=' lowercase cursor-pointer'>Terms & COnditions</p>
    </div>
