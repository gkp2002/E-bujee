...
function Contact() {
  return (
    ...
    <input required className=" placeholder:text-white  font-medium md:w-[33vw] max-h-11 my-1 border-b-2 border-white md:text-[1.2vmax] text-xl pt-6 pb-12 pl-3 mx-5 min-h-11 text-white bg-transparent" type="text" placeholder="Name*"/>
    <input required className=" placeholder:text-white  font-medium md:w-[33vw] max-h-11 my-1 border-b-2 border-white md:text-[1.2vmax] text-xl pt-6 pb-12 pl-3 mx-5 min-h-11 text-white bg-transparent" type="text"  placeholder="Company*"/>
    </div>
      <div className="md:flex block  md:py-6">
      <input required className=" placeholder:text-white  font-medium md:w-[33vw] max-h-11 my-1 border-b-2 border-white md:text-[1.2vmax] text-xl pt-6 pb-12 pl-3 mx-5 min-h-11  bg-transparent text-white" type="Email" placeholder="Email*"/>
      <input required className=" placeholder:text-white  font-medium md:w-[33vw] max-h-11 my-1 border-b-2 border-white md:text-[1.2vmax] text-xl pt-6 pb-12 pl-3 mx-5 min-h-11 bg-transparent text-white " type="tel"  placeholder="Phone*"/>
      </div>     
     
   
      <textarea name="" id="" cols="30" rows="10" placeholder="Tell us about your Project *" required
