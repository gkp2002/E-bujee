    ...
    <div>
      ...
      <div className='text-white text-6xl font-bold pb-4' data-aos="fade-up">Our <span className='text-stroke-2 text-orange-500'>Services</span></div>
        ...
        <NavLink className=" mx-1" to="BrandSolution" >
          <div className="text-[1.5vmax] border-orange-600 hover:bg-orange-500 border-2 rounded-3xl   text-white  px-[3vmax]  py-2  ">
            Brand Solution
          </div> 
          </NavLink>
          <NavLink className=" mx-1"  to="Design">
          <div className="text-[1.5vmax] border-orange-600 hover:bg-orange-500 border-2 rounded-3xl   text-white  px-[3vmax]  py-2  ">
            Design
          </div>
          </NavLink>
          <NavLink className=" mx-1" to="Development">
          <div className="text-[1.5vmax] border-orange-600 hover:bg-orange-500 border-2 rounded-3xl   text-white  px-[3vmax]  py-2  ">
            Development
          </div>
          </NavLink>
          <NavLink className=" mx-1" to="TechSoluton">
          <div className="text-[1.5vmax] border-orange-600 hover:bg-orange-500 border-2 rounded-3xl   text-white  px-[3vmax]  py-2  ">
            Tech Solution
          </div>
          </NavLink>
          <NavLink className=" mx-1" to="E-commerce">
          <div className="text-[1.5vmax] border-orange-600 hover:bg-orange-500 border-2 rounded-3xl   text-white  px-[3vmax]  py-2  ">
           E-commerce
          </div>
          </NavLink>
          <NavLink className=" mx-1" to="Marketing">
          <div className="text-[1.5vmax] border-orange-600 hover:bg-orange-500 border-2 rounded-3xl   text-white  px-[3vmax]  py-2  ">
            Marketing
          </div>
          </NavLink>
